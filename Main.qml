...
PlasmaCore.ColorScope {
    ...
    readonly property color backgroundColor: "#3c3836"
    readonly property color textColor: "#ebdbb2"
    readonly property color accentColor: "#665c54"

    readonly property bool lightBackground: Math.max(backgroundColor.r, backgroundColor.g, backgroundColor.b) > 0.5
    ...
    MouseArea {
        ...
        DropShadow {
            ...
            color: root.lightBackground ? Qt.rgba(backgroundColor.r,
                                                  backgroundColor.g,
                                                  backgroundColor.b,
                                                  0.6)
